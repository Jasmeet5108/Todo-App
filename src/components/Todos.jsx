        ...
        <>
            ...
            <div className="my-container">
                ...
                <form onSubmit={saveData}>
                    <div className='text-black flex flex-col p-2 gap-8 items-center mt-5 w-[340px] sm:w-[600px] mx-auto'>

                        <input name="name" onChange={handleChange} value={form.name} className='rounded-xl border border-green-500 w-full px-4 py-1' type="text" id='' placeholder='Enter your name' required />

                        <input name="todo" onChange={handleChange} value={form.todo} className='rounded-xl border border-green-500 w-full px-4 py-1' type="text" id='' placeholder='Enter task here' required />

                        <button type='submit' className='w-fit font-semibold text-white flex justify-center items-center gap-2 bg-cyan-600 rounded-full px-8 py-2 border border-green-900'>
                ...
                {/* Display saved todos */}
                <div className="todos mt-7">
                    <h2 className='font-semibold text-2xl py-4 text-white text-center underline underline-offset-4'>Your Todo List</h2>
                    {
                        todoArray.length === 0 &&
                        <>
                            <div className='w-40 mt-3 py-1 border border-white rounded-md mx-auto text-white text-center font-semibold bg-gradient-to-l from-fuchsia-500 to-pink-600'>{editing ? "Edit in the form" : "No Todos Found"}</div>
                            {editing === false && <div>
                                <img src="/nothing-here-unscreen.gif" className='block mx-auto mt-1 pl-4 sm:w-44' width={120} alt="Nothing here" />
                            </div>}
                        </>
                    }
                    ...
                    {
                        todoArray.length != 0 &&
                        <table className="table-auto w-[350px] mx-auto rounded-md overflow-hidden sm:w-[600px] lg:w-[1000px]">
